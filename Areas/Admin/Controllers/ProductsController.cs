...
namespace Project.Areas.Admin.Controllers
{
    ...
    public class ProductsController : Controller
    {
        ...
        public IActionResult UpdatePost(int id, IFormCollection fc)
        {
            ...
            // lay record tuong ung voi id truyen vao de update du lieu 
            ItemProduct record = db.Products.FirstOrDefault(item => item.Id == id);
            if (record != null)
            {
                record.Name = _Name;
                ...
                // kiem tra lay anh thay doi thi update anh 
                try
                {
            ...
            // xoa casc ban ghi tuong ung voi ProductId trong bang categories de update lai ban ghi moi 
